<template>
  <div id="rootdiv">
    <div class="maincontents" style="float: left; width: 75%;">
    ...
    <div class="sidecontents" style="height:100%">
        ...
        <p class="sidecontents_contents">심마니는 산삼(인삼)을 캐는 사람입니다.<br>흔히들 알고 있는, "심봤다!" 를 외치는 사람들입니다.</p>
        ...
        <p class="sidecontents_contents">우리는 반복된 연구와 식물학 공부로, 인삼이 자라기에<br>가장 적합한 적색광/청색광 간의 비율, 양액과 물의<br> 비율,공기상태와 온도 등을 알아냈습니다.</p>
        <p class="sidecontents_contents">그렇게 3달간 쌓아온 지식을 우리의 기술력과 합쳤습니다. 우리가 만든 장치들은 우리가 연구한, 인삼이 가장 잘 자랄 수 있는 환경이 될 수 있도록 조절해 줍니다.</p>
        <p class="sidecontents_contents">그 덕분에, 우리의 제품은 마치 사람이 세심한 관리를<br> 하는 것과 같이 인삼을 돌볼 수 있습니다. </p>
    </div>
